...
if __name__ == "__main__":
    ...
    style_images_path = os.path.join(os.path.dirname(__file__), 'Style')
    ...
    # training related
    parser.add_argument("--style_img_name", type=str, help="style image name that will be used for training", default='Water Lilies.jpg')
